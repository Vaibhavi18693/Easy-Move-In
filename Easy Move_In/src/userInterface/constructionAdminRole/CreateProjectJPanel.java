...
public class CreateProjectJPanel extends javax.swing.JPanel {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(createRequestButton, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)))
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(budget, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void createRequestButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_createRequestButtonMouseClicked
        ...
        try {
            ...
            if (!(projectName.equals("") || projection.equals("")))  {
                if (projection.matches("^[0-9]+$")) {
                    ...
                    Date startDate = Date.valueOf(startDatePicker.getDate());
                    Date endDate = Date.valueOf(endDatePicker.getDate());
                    if(startDate.compareTo(new java.util.Date()) < 0) {
                        JOptionPane.showMessageDialog(null, "Choose a future start date");
                        return;
                    }
                    
                    if (startDate.compareTo(endDate) > 0){
                        JOptionPane.showMessageDialog(null, "Start date and end date are not in correct order!!");
                        return;
                    }
                    
                    project.setStartDate(startDate);
                    project.setExpectedEndDate(endDate);
